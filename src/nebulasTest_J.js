...
//n1P3aBFGDgBRyNJqxqWEPStLrdojkWrzNGh
//n1Y9svQj6J5b3bvLmj2Bf7WG6xk8NoZxT88
//api.getAccountState({address: "n1qGHtVR16SDtuzM9KSGvxtpT9PpUfr8QaR"}).then(function(state) {
api.getAccountState({address: "n1Y9svQj6J5b3bvLmj2Bf7WG6xk8NoZxT88"}).then(function(state) {
    console.log("\n\n")
    console.log(state)
});
...
console.log(from)
console.log("\n\n\n")
var dappAddress = "n1oNgmipR9dR5rvfqXhaZuEoBZgiX1XeWJT"
var value = "0";
var nonce = "0"
var gas_price = "1000000"
var gas_limit = "2000000"
var callFunction = "get";
var callArgs = "[\"" + "jimmy" + "\"]"; //in the form of ["args"]
var contract = {
